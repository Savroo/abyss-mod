...
public class ModItems {
    ...
    public static final Item CHICKEN_NUGGET = registerItem("chicken_nugget", new Item(new Item.Settings().food(ModFoodComponents.chicken_nugget)));
    public static final Item CASINO_CHIP = registerItem("casino_chip", new Item(new Item.Settings()));
